...
link /SUBSYSTEM:WINDOWS  /LIBPATH:c:\masm32\lib  game.obj blit.obj lines.obj stars.obj galagaShip.obj galagaShot.obj yellowBug.obj galagaStart.obj libgame.obj || goto :error
